class Solution {
    /* 
        Approach is to use a monotonic stack storing indicies from the temperatures array, i.e., values on top will be less than values lower
        ...
        While moving back, if the index isin't the poped element, add 1 to the count
